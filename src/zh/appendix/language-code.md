...
head:
  - - meta
    - name: description
      content: ISO6391语言代码|一个轻量级、语义化、对开发者友好的 golang 时间处理库
  - - meta
    - name: keywords
      content: ISO6391, 语言代码, 国际化, i18n, 语言标准, 双字母代码
---

# ISO6391 语言代码对照表

根据 ISO 639-1 标准，以下是常用的双字母语言代码对照表：
...
| zh-TW   | Chinese (Taiwan)  | 中文(台湾)   | 台湾       |
| zh-HK   | Chinese (Hong Kong) | 中文(香港) | 香港       |
