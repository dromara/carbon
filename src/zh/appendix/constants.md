...
head:
  - - meta
    - name: description
      content: Carbon 库内置常量参考手册，包含版本、时区、月份、季节、星座、星期、数字常量以及完整的布局模板和格式常量，涵盖 RFC、ISO8601 等国际标准格式
  - - meta
    - name: keywords
      content: 版本常量, 时区常量, 月份常量, 季节常量, 星座常量, 星期常量, 数字常量, 布局模板常量, RFC格式, ISO8601格式, 时间格式化
---
