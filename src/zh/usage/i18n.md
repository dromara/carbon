...
head:
  - - meta
    - name: description
      content: Carbon国际化功能详解，支持25种本地化语言，提供星座季节月份星期的本地化输出，支持自定义翻译资源和区域设置，包含完整的多语言使用示例和配置方法
  - - meta
    - name: keywords
      content: carbon, go-carbon, 国际化, i18n, 本地化, 多语言, 区域设置, 翻译资源, 星座, 季节, DiffForHumans, 语言支持
---
