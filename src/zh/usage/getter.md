...
head:
  - - meta
    - name: description
      content: Carbon 时间获取方法大全，提供年月日时分秒组成部分、年内月内周内序号、多精度时间戳、时区信息、本地化星座季节、一周起止日期、布局模板与年龄计算等 30+ 种获取方法
  - - meta
    - name: keywords
      content: carbon, go-carbon, 时间获取, getter方法, 年月日, 时分秒, 时间戳, 时区信息, 本地化, 星座, 季节, 年龄计算
---
