...
head:
  - - meta
    - name: description
      content: "율리우스일/수정 율리우스일, 중국 음력, 페르시아력, 히브리력을 지원하며, 그레고리력과의 상호 변환, 포맷팅(월/주/일 문자열), 유효성 및 윤년 판단 등을 제공합니다"
  - - meta
    - name: keywords
      content: "carbon, go-carbon, 달력, 그레고리력, 율리우스일, 수정 율리우스일, 중국 음력, 페르시아력, 이란력, 히브리력, 유대력"
---
