...
head:
  - - meta
    - name: description
      content: "Carbon 국제화 기능 상세 설명, 25 개의 현지화 언어 지원, 별자리 계절 월 요일의 현지화 출력 제공, 사용자 정의 번역 리소스 및 로케일 설정 지원, 완전한 다국어 사용 예제 및 설정 방법 포함"
  - - meta
    - name: keywords
      content: "carbon, go-carbon, 국제화, i18n, 현지화, 다국어, 로케일 설정, 번역 리소스, 별자리, 계절, DiffForHumans, 언어 지원"
---
...
* [아프리칸스어(af)](https://github.com/dromara/carbon/blob/master/lang/af.json "아프리칸스어"): [cursor](https://cursor.com "cursor") 번역
* [몽골어(mn)](https://github.com/dromara/carbon/blob/master/lang/mn.json "몽골어"): [cursor](https://cursor.com "cursor") 번역

[Carbon에 새로운 로컬라이즈드 언어 지원을 추가하는 방법](../appendix/contribution-guide.md)
