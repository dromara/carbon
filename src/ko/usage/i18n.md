...
head:
  - - meta
    - name: description
      content: 국제화 | Language/SetLocale 로 현지화 설정 제공, Constellation/Season/DiffForHumans/ToMonthString/ToShortMonthString/ToWeekString/ToShortWeekString 등 출력 지원, 로케일별 부분 리소스 덮어쓰기 또는 전체 재정의 가능
  - - meta
    - name: keywords
