...
head:
  - - meta
    - name: description
      content: "Carbon 라이브러리 내장 상수 참조 매뉴얼, 버전, 타임존, 월, 계절, 별자리, 요일, 숫자 상수 및 완전한 레이아웃 템플릿과 형식 상수를 포함하며, RFC, ISO8601 등의 국제 표준 형식을 다룹니다"
  - - meta
    - name: keywords
      content: "버전 상수, 타임존 상수, 월 상수, 계절 상수, 별자리 상수, 요일 상수, 숫자 상수, 레이아웃 템플릿 상수, RFC 형식, ISO8601 형식, 시간 형식화"
---
