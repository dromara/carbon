...
head:
  - - meta
    - name: description
      content: "Carbon internationalization feature detailed explanation, supports 25 localized languages, provides localized output for constellation, season, month and weekday, supports custom translation resources and locale settings, includes complete multilingual usage examples and configuration methods"
  - - meta
    - name: keywords
      content: "carbon, go-carbon, internationalization, i18n, localization, multilingual, locale settings, translation resources, constellation, season, DiffForHumans, language support"
---
...
* [Afrikaans(af)](https://github.com/dromara/carbon/blob/master/lang/af.json "Afrikaans"): translated by [cursor](https://cursor.com "cursor")
* [Mongolian(mn)](https://github.com/dromara/carbon/blob/master/lang/mn.json "Mongolian"): translated by [cursor](https://cursor.com "cursor")

[How to add new localized language support to carbon](../appendix/contribution-guide.md)
