...
Parse a time string as a `Carbon` instance by default layout templates
```go
...
## Parse by a layout template
Parse a time string as a `Carbon` instance by a confirmed layout template
```go
...
## Parse by a format template
Parse a time string as a `Carbon` instance by a confirmed format template
> Note: If the letter used conflicts with the format template, please use the escape character "\\" to escape the letter
...
## Parse by multiple layout templates
Parse a time string as a `Carbon` instance by multiple fuzzy layout templates
```go
...
## Parse by multiple format templates
Parse a time string as a `Carbon` instance by multiple fuzzy format templates
```go
