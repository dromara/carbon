...
head:
  - - meta
    - name: description
      content: "Carbon 国際化機能の詳細説明、25 種類のローカライズ言語をサポート、星座季節月曜日のローカライズ出力を提供、カスタム翻訳リソースとロケール設定をサポート、完全な多言語使用例と設定方法を含む"
  - - meta
    - name: keywords
      content: "carbon, go-carbon, 国際化, i18n, ローカライズ, 多言語, ロケール設定, 翻訳リソース, 星座, 季節, DiffForHumans, 言語サポート"
---
...
* [アフリカーンス語(af)](https://github.com/dromara/carbon/blob/master/lang/af.json "アフリカーンス語"): [cursor](https://cursor.com "cursor") に翻訳
* [モンゴル語(mn)](https://github.com/dromara/carbon/blob/master/lang/mn.json "モンゴル語"): [cursor](https://cursor.com "cursor") に翻訳

[Carbon に新しいローカライズ言語サポートを追加する方法](../appendix/contribution-guide.md)
