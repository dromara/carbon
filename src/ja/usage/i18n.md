...
head:
  - - meta
    - name: description
      content: 国際化 | Language/SetLocale によるローカライズ設定を提供し、Constellation/Season/DiffForHumans/ToMonthString/ToShortMonthString/ToWeekString/ToShortWeekString などの出力をサポート。ロケールに基づく一部リソースの上書きや、全リソースの再定義にも対応
  - - meta
    - name: keywords
