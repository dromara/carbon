...
head:
  - - meta
    - name: description
      content: Carbon 時間取得メソッド大全、年月日時分秒構成要素、年内月内週内序数、多精度タイムスタンプ、タイムゾーン情報、ローカライズされた星座と季節、週の開始/終了日、レイアウトテンプレートと年齢計算など 30+ 種類の取得メソッドを提供
  - - meta
    - name: keywords
      content: carbon, go-carbon, 時間取得, getterメソッド, 年月日, 時分秒, タイムスタンプ, タイムゾーン情報, ローカライズ, 星座, 季節, 年齢計算
---
