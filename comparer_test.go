...
func TestCarbon_IsSameCentury(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameCentury(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameCentury(Parse("xx")))
		assert.False(t, Parse("").IsSameCentury(Parse("")))
	})
...
func TestCarbon_IsSameDecade(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameDecade(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameDecade(Parse("")))
		assert.False(t, Parse("").IsSameDecade(Parse("")))
	})
...
func TestCarbon_IsSameYear(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameYear(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameYear(Parse("")))
		assert.False(t, Parse("").IsSameYear(Parse("")))
	})
...
func TestCarbon_IsSameQuarter(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameQuarter(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameQuarter(Parse("")))
		assert.False(t, Parse("").IsSameQuarter(Parse("")))
	})
...
func TestCarbon_IsSameMonth(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameMonth(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameMonth(Parse("")))
		assert.False(t, Parse("").IsSameMonth(Parse("")))
	})
...
func TestCarbon_IsSameDay(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameDay(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameDay(Parse("")))
		assert.False(t, Parse("").IsSameDay(Parse("")))
	})
...
func TestCarbon_IsSameHour(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameHour(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameHour(Parse("")))
		assert.False(t, Parse("").IsSameHour(Parse("")))
	})
...
func TestCarbon_IsSameMinute(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameMinute(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameMinute(Parse("")))
		assert.False(t, Parse("").IsSameMinute(Parse("")))
	})
...
func TestCarbon_IsSameSecond(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").IsSameSecond(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").IsSameSecond(Parse("")))
		assert.False(t, Parse("").IsSameSecond(Parse("")))
	})
...
func TestCarbon_Compare(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Compare("<", Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Compare(">", Parse("")))
		assert.False(t, Parse("").Compare("!=", Parse("")))
	})
...
func TestCarbon_Gt(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Gt(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Gt(Parse("")))
		assert.False(t, Parse("").Gt(Parse("")))
	})
...
func TestCarbon_Lt(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Lt(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Lt(Parse("")))
		assert.False(t, Parse("").Lt(Parse("")))
	})
...
func TestCarbon_Eq(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Eq(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Eq(Parse("")))
		assert.False(t, Parse("").Eq(Parse("")))
	})
...
func TestCarbon_Ne(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Ne(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Ne(Parse("")))
		assert.False(t, Parse("").Ne(Parse("")))
	})
...
func TestCarbon_Gte(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Gte(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Gte(Parse("")))
...
func TestCarbon_Lte(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Lte(Parse("2020-08-05")))
		assert.False(t, Parse("2020-08-05").Lte(Parse("")))
		assert.False(t, Parse("").Lte(Parse("")))
	})
...
func TestCarbon_Between(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").Between(Parse(""), Parse("")))

		assert.False(t, Parse("").Between(Parse(""), Parse("2020-08-05")))
		assert.False(t, Parse("").Between(Parse("2020-08-05"), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").Between(Parse(""), Parse("xxx")))
		assert.False(t, Parse("2020-08-05").Between(Parse(""), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").Between(Parse("2020-08-05"), Parse("")))
		assert.False(t, Parse("").Between(Parse("2020-08-05"), Parse("")))
	})
...
func TestCarbon_BetweenIncludedStart(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").BetweenIncludedStart(Parse(""), Parse("")))

		assert.False(t, Parse("").BetweenIncludedStart(Parse(""), Parse("2020-08-05")))
		assert.False(t, Parse("").BetweenIncludedStart(Parse("2020-08-05"), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedStart(Parse(""), Parse("")))
		assert.False(t, Parse("2020-08-05").BetweenIncludedStart(Parse(""), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedStart(Parse("2020-08-05"), Parse("")))
		assert.False(t, Parse("").BetweenIncludedStart(Parse("2020-08-05"), Parse("")))
	})
...
func TestCarbon_BetweenIncludedEnd(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").BetweenIncludedEnd(Parse(""), Parse("")))

		assert.False(t, Parse("").BetweenIncludedEnd(Parse(""), Parse("2020-08-05")))
		assert.False(t, Parse("").BetweenIncludedEnd(Parse("2020-08-05"), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedEnd(Parse(""), Parse("")))
		assert.False(t, Parse("2020-08-05").BetweenIncludedEnd(Parse(""), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedEnd(Parse("2020-08-05"), Parse("")))
		assert.False(t, Parse("").BetweenIncludedEnd(Parse("2020-08-05"), Parse("")))
	})
...
func TestCarbon_BetweenIncludedBoth(t *testing.T) {
	...
	t.Run("empty carbon", func(t *testing.T) {
		assert.False(t, Parse("").BetweenIncludedBoth(Parse(""), Parse("")))

		assert.False(t, Parse("").BetweenIncludedBoth(Parse(""), Parse("2020-08-05")))
		assert.False(t, Parse("").BetweenIncludedBoth(Parse("2020-08-05"), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedBoth(Parse(""), Parse("")))
		assert.False(t, Parse("2020-08-05").BetweenIncludedBoth(Parse(""), Parse("2020-08-05")))

		assert.False(t, Parse("2020-08-05").BetweenIncludedBoth(Parse("2020-08-05"), Parse("")))
		assert.False(t, Parse("").BetweenIncludedBoth(Parse("2020-08-05"), Parse("")))
	})
