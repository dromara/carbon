...
func BenchmarkVLunar_YearHeavenStem(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.YearHeavenStem()
	}
...
func BenchmarkVLunar_YearName(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.YearName()
	}
...
func BenchmarkVLunar_MonthHeavenStem(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.MonthHeavenStem()
	}
...
func BenchmarkVLunar_MonthAnimal(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.MonthAnimal()
	}
...
func BenchmarkVLunar_MonthName(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.MonthName()
	}
...
func BenchmarkVLunar_LuckyHours(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.LuckyHours()
	}
...
func BenchmarkVLunar_DayHeavenStem(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.DayHeavenStem()
	}
...
func BenchmarkVLunar_DayAnimal(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.DayAnimal()
	}
...
func BenchmarkVLunar_DayName(b *testing.B) {
	l := Now().VLunar()
	for n := 0; n < b.N; n++ {
		l.DayName()
	}
